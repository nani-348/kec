...
export default function RegionMap() {
    ...
    return (
        <>
            {/* Inline Preview */}
            <div
                className="relative w-full h-[300px] lg:h-[400px] rounded-2xl overflow-hidden shadow-lg border border-gray-100 bg-gray-50 group cursor-pointer"
                onClick={() => setIsExpanded(true)}
            >
                <Image
                    src={imageSrc}
                    alt={`${imageAlt} - Click to Expand`}
                    fill
