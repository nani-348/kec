...
export default function RegionMap() {
    ...
    return (
        <>
            {/* Inline Preview */}
            <div className="relative w-full h-[300px] lg:h-[400px] rounded-2xl overflow-hidden shadow-lg border border-gray-100 bg-gray-50 group cursor-pointer"
                onClick={() => setIsExpanded(true)}>
                <Image
                    src="/images/about-kada/page1_img7.png"
                    alt="KADA Region Map - Click to Expand"
                    fill
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative w-full h-full rounded-lg overflow-hidden">
                                <Image
                                    src="/images/about-kada/page1_img7.png"
                                    alt="KADA Region Map - Fullscreen"
                                    fill
