...
// Station Data based on extraction (Page 7/8 PDF)
// Values are approximate based on the text block parsing
const STATION_DATA = [
    // Gudi Palle Mandal
    ...
    { id: 12, name: "Rallaboduguru", mandal: "Shanthipuram", may: 2.10, nov: 1.00, status: "Safe" }, // Exceptionally shallow
...
export default function PiezometerObsPage() {
    ...
    const mandals = ["All", ...Array.from(new Set(STATION_DATA.map(s => s.mandal)))];
