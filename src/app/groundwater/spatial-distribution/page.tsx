...
const MANDAL_SNAPSHOTS = [
    {
        ...
        trend: "Stable",
        stations: 3,
        coordinates: { x: 20, y: 30 }, // Schematic position %
    ...
    },
    {
        ...
        name: "Shanthipuram",
        avgDepth: 10.06,
        status: "Moderate", // Borderline Safe
        trend: "Improving",
        stations: 4,
...
// Full Station List for Grid
const ALL_STATIONS = [
    { id: 1, name: "Dravida University", mandal: "Gudupalle", depth: 12.87, status: "Moderate" },
    { id: 2, name: "Gudupalle HQ", mandal: "Gudupalle", depth: 31.07, status: "Critical" },
    { id: 3, name: "Solachinthanapalli", mandal: "Gudupalle", depth: 39.24, status: "Critical" },
    { id: 4, name: "Adaviboduguru", mandal: "Kuppam", depth: 25.41, status: "Critical" },
    { id: 5, name: "Kangundhi", mandal: "Kuppam", depth: 3.52, status: "Safe" },
    { id: 6, name: "Balla", mandal: "Ramakuppam", depth: 12.91, status: "Moderate" },
    { id: 7, name: "Cheldiganipalle", mandal: "Ramakuppam", depth: 20.96, status: "Critical" }, // Borderline
    { id: 8, name: "Ramakuppam HQ", mandal: "Ramakuppam", depth: 12.05, status: "Moderate" },
    { id: 9, name: "Vijilapuram", mandal: "Ramakuppam", depth: 6.39, status: "Safe" },
    { id: 10, name: "Anikera", mandal: "Shanthipuram", depth: 9.36, status: "Safe" },
    { id: 11, name: "Gundusettipalli", mandal: "Shanthipuram", depth: 14.84, status: "Moderate" },
    { id: 12, name: "Rallaboduguru", mandal: "Shanthipuram", depth: 1.00, status: "Safe" },
    { id: 13, name: "Shanthipuram HQ", mandal: "Shanthipuram", depth: 15.05, status: "Moderate" },
];
                                ...
                                {filteredStations.length > 0 ? (
                                    filteredStations.map((station) => (
                                        <tr key={station.id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-3 text-right font-bold text-gray-900">{station.depth.toFixed(2)} m</td>
