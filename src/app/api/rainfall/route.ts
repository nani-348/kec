...
const SHEET_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSQt4tCGjYm78UXtlulNkF4TjiFCsJuGlXTAwNLGm-vMPToMEqLwH9_dI_8WScvOKoBAQNNPxwH_iWK/pub?output=csv";
...
export async function GET() {
  try {
    ...
    mandals.forEach(m => { monthlyData[m] = {}; for (let i = 1; i <= 12; i++) monthlyData[m][i] = 0; });
