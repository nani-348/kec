                            ...
                            <div className="space-y-4 text-gray-600 leading-relaxed">
                                ...
                                <ul className="space-y-3 bg-white p-6 rounded-xl border border-gray-100 shadow-sm mt-4">
                                    <li className="flex items-center gap-2">
                                        ...
                                        <span className="font-semibold text-gray-900">Total Sinks Identified:</span> 268
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <span className="w-2 h-2 rounded-full bg-indigo-500"></span>
                                        <span className="font-semibold text-gray-900">Subsurface Sinks:</span> 139 (Primary Recharge)
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <span className="w-2 h-2 rounded-full bg-cyan-500"></span>
                                        <span className="font-semibold text-gray-900">Surface Sinks:</span> 39
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <span className="w-2 h-2 rounded-full bg-gray-400"></span>
                                        <span className="font-semibold text-gray-900">Interactive Sinks:</span> 90
                                    </li>
                                </ul>
                            </div>
                        </div>
