...
import { Trees, CloudRain, Mountain, Map } from "lucide-react";
                        ...
                        <table className="w-full text-sm text-left">
                            <thead className="text-xs text-gray-500 uppercase bg-gray-50/50">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 font-medium">Rainfall (mm)</th>
                                </tr>
                            </thead>
                            ...
                            <tfoot className="bg-primary/5 font-semibold text-gray-900">
                                <tr>
                                    ...
                                    <td className="px-6 py-4">105,190</td>
                                    <td className="px-6 py-4">71,790</td>
                                    <td className="px-6 py-4">33,400</td>
                                    <td className="px-6 py-4">827 (Avg)</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
